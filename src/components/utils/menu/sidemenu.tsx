...
export const PersistentSidebar: Component<{
  ...
  return (
    <>
      ...
      <div id="sidebar-container" classList={sidebarClass()} onMouseOver={() => window.innerWidth > 768 && props.setExpanded(true)} onMouseLeave={() => window.innerWidth > 768 && props.setExpanded(false)}>
        <a href="#">
        ...
        <div class="submenu-wrapper">
          <a href="#" class="has-submenu" onClick={toggleSettingsSubmenu}>
            <i class="fas fa-cog"></i> <span>Settings</span> <i class={`fas fa-chevron-${settingsExpanded() ? 'down' : 'right'} chevron`}></i>
          </a>
        ...
        <div class="submenu-wrapper">
          <a href="#" class="has-submenu" onClick={toggleProfileSubmenu}>
            <i class="fas fa-user"></i> <span>Profile</span> <i class={`fas fa-chevron-${profileExpanded() ? 'down' : 'right'} chevron`}></i>
          </a>
    ...
    <div class="container-fluid text-center">
      ...
      <div class="row gy-4" style={"margin-bottom: 10px"}>
        <div class="col-12 col-md-3">
          <div class="card">
            <img src="https://picsum.photos/200" class="card-img-top" alt="Card 2-1"/>
            <div class="card-body">
        ...
        <div class="col-12 col-md-3">
          <div class="card">
            <img src="https://picsum.photos/200" class="card-img-top" alt="Card 2-2"/>
            <div class="card-body">
              <h5 class="card-title">Card 2-2</h5>
              <p class="card-text">Second card in the second row.</p>
              <a href="#" class="btn btn-secondary">Check</a>
            </div>
          </div>
        </div>
        <div class="col-12 col-md-3">
          <div class="card">
            <img src="https://picsum.photos/200" class="card-img-top" alt="Card 2-3"/>
            <div class="card-body">
        ...
        <div class="col-12 col-md-3">
          <div class="card">
            <img src="https://picsum.photos/200" class="card-img-top" alt="Card 2-4"/>
            <div class="card-body">
      ...
      <div class="row gy-4" style={"margin-bottom: 10px"}>
        <div class="col-12 col-md-5ths">
          <div class="card">
            <img src="https://picsum.photos/200" class="card-img-top" alt="Card 3-1"/>
            <div class="card-body">
        ...
        <div class="col-12 col-md-5ths">
          <div class="card">
            <img src="https://picsum.photos/200" class="card-img-top" alt="Card 3-2"/>
            <div class="card-body">
        ...
        <div class="col-12 col-md-5ths">
          <div class="card">
            <img src="https://picsum.photos/200" class="card-img-top" alt="Card 3-3"/>
            <div class="card-body">
              <h5 class="card-title">Card 3-3</h5>
              <p class="card-text">Third card in the third row.</p>
              <a href="#" class="btn btn-warning">Find</a>
            </div>
          </div>
        </div>
        <div class="col-12 col-md-5ths">
          <div class="card">
            <img src="https://picsum.photos/200" class="card-img-top" alt="Card 3-4"/>
            <div class="card-body">
              <h5 class="card-title">Card 3-4</h5>
              <p class="card-text">Fourth card in the third row.</p>
              <a href="#" class="btn btn-info">Look</a>
            </div>
          </div>
        </div>
        <div class="col-12 col-md-5ths">
          <div class="card">
            <img src="https://picsum.photos/200" class="card-img-top" alt="Card 3-5"/>
            <div class="card-body">
              <h5 class="card-title">Card 3-5</h5>
              <p class="card-text">Fifth card in the third row.</p>
              <a href="#" class="btn btn-secondary">Try</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row gy-4" style={"margin-bottom: 10px"}>
        <div class="col-12 col-md-6">
          <div class="card">
            <img src="https://picsum.photos/200" class="card-img-top" alt="Card 4-1"/>
            <div class="card-body">
        ...
        <div class="col-12 col-md-6">
          <div class="card">
            <img src="https://picsum.photos/200" class="card-img-top" alt="Card 4-2"/>
            <div class="card-body">
              <h5 class="card-title">Card 4-2</h5>
              <p class="card-text">Second card in the fourth row.</p>
              <a href="#" class="btn btn-dark">End</a>
            </div>
          </div>
        </div>
      </div>
