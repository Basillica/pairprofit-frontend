        ...
        <Portal>
            <Show when={props.isOpen()}>
                <div
                    ...
                    class="fixed inset-0 bg-gray-200 bg-opacity-75 flex items-center justify-center p-4 transition-opacity duration-300 ease-out"
                >
...
//         } else {
//             setContactMethods(
//                 contactMethods().filter((method) => method !== value)
//             );
//         }
//     };
...
//         alert(
//             'Provider Profile created successfully! (Check console for data)'
//         );
//     };
...
//     console.log(props.isOpen(), 'props.isOpen()props.isOpen()props.isOpen()');
