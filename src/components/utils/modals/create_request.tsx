        ...
        <Portal>
            <Show when={props.isOpen()}>
                <div
                    ...
                    class="fixed inset-0 bg-gray-200 bg-opacity-75 flex items-center justify-center mt-10 p-4 transition-opacity duration-300 ease-out z-[9999]"
                >
                    <div class={modal_styles.modal_content}>
                        ...
                        <p class="text-gray-600 text-center mb-8">
                            Tell us what kind of assistance you need. Artisans
                            will see your request and can reach out to offer
                            their services!
                        </p>
                            ...
                            <form onSubmit={handleSubmit} class="space-y-6">
                                    ...
                                    <div class="bg-blue-50 border border-green-600 p-4 rounded-md mb-4">
                                        <p class="text-blue-800 font-medium">
                                            <span class="font-semibold">
                                                ℹ️ Here you will need to provide
                                                basic information about the
                                                service you are looking for
                                            </span>
                                        </p>
                                        <p class="text-gray-700 text-sm mt-2">
                                            Provide a category and subcategory
                                            to give artisans more context about
                                            what you need
                                        </p>
                                    </div>
                                ...
                                <section class="border-b border-gray-200 pb-6 pt-6">
                                    ...
                                    <div class="bg-green-50 border border-gray-600 p-4 rounded-md mb-4">
                                        <p class="text-blue-800 font-medium">
                                            <span class="font-semibold">
                                                ℹ️ Provide information about the
                                                location where the service is
                                                needed
                                            </span>
                                        </p>
                                        <p class="text-blue-700 text-sm mt-2">
                                            This will help us match you with
                                ...
                                <section class="border-b border-gray-200 pb-6 pt-6">
                                    ...
                                    <div class="bg-blue-50 border border-green-600 p-4 rounded-md mb-4">
                                        <p class="text-blue-800 font-medium">
                                            <span class="font-semibold">
                                                ℹ️ Specify what your budget
                                                would be
                                            </span>
                                        </p>
                                        <p class="text-gray-700 text-sm mt-2">
                                            You can also make it negptiable and
                                            speak with the artisan about it
                                            later
                                        </p>
                                    </div>
                                    <div>
                                        ...
                                        <p class="mt-2 text-sm text-gray-500">
                                            Providing a budget helps artisans
                                ...
                                <section class="border-b border-gray-200 pb-6 pt-6">
                                    ...
                                    <div class="mt-6">
                                        ...
                                        <p class="mt-2 text-xs text-gray-500">
                                            Max 5 files. JPG, PNG, PDF, DOCX
                                            allowed. Max 5MB per file.
                                        </p>
                                ...
                                <section class="pt-6">
                                    ...
                                    <div class="bg-blue-50 border border-blue-200 p-4 rounded-md mb-4">
                                        <p class="text-blue-800 font-medium">
                                            ...
                                            for initial contact to ensure your
                                            privacy and keep communications
                                            organized.
                                        </p>
                                        <p class="text-blue-700 text-sm mt-2">
                                            You can exchange phone numbers or
                                            emails with an artisan later if you
                                            choose.
                                        </p>
                                    </div>
                                ...
                                <section class="border-b border-gray-200 pb-6 pt-6">
                                    ...
                                    <div class="bg-green-50 border border-yellow-600 p-4 rounded-md mb-4">
                                        <p class="text-blue-800 font-medium">
                                            <span class="font-semibold">
                                                ℹ️ Here you can specify the
                                                urgency of the request:
                                            </span>
                                        </p>
                                        <p class="text-blue-700 text-sm mt-2">
                                            depending on the urgency of the
                                            request so that artisans can
                                            prioritize them
                                        </p>
                                    </div>
