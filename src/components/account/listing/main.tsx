...
export const ServiceProviderListings = (): JSX.Element => {
  ...
  const mockProfiles = [
    {
        ...
        description: 'Experienced carpenter specializing in custom woodwork and furniture.',
        imageUrl: 'https://source.unsplash.com/random/150x150/?carpenter',
    },
    {
        id: 2,
        name: 'Jane Doe',
        ...
        rating: 4.8,
        yearsOfExperience: 8,
        description: 'Certified teacher with a passion for helping students achieve their full potential.',
        imageUrl: 'https://source.unsplash.com/random/150x150/?teacher',
    },
    {
        id: 3,
        name: 'David Lee',
        ...
        description: 'Professional engineer specializing in structural design and project management.',
        imageUrl: 'https://source.unsplash.com/random/150x150/?engineer',
    },
     {
        id: 4,
        name: 'Sarah Williams',
        ...
        imageUrl: 'https://source.unsplash.com/random/150x150/?electrician',
    },
    {
        id: 5,
        name: 'Michael Brown',
        ...
        description: 'Master plumber specializing in complex plumbing installations and repairs.',
        imageUrl: 'https://source.unsplash.com/random/150x150/?plumber',
    },
    {
        id: 6,
        name: 'Maria Garcia',
        ...
        rating: 4.6,
        yearsOfExperience: 9,
        description: 'Experienced chef offering catering services and private cooking lessons.',
        imageUrl: 'https://source.unsplash.com/random/150x150/?chef',
    },
];
  ...
  const handleApplyFilters = () => {
    ...
    const filteredProfiles = mockProfiles.filter(profile => {
      const categoryMatch = !selectedCategory || profile.category.toLowerCase().includes(selectedCategory.toLowerCase());
      const locationMatch = !selectedLocation || profile.location.toLowerCase() === selectedLocation.toLowerCase();
  ...
  return (
    <div class="container-fluid mx-auto">
        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 row-cols-xl-5" style={"min-heighter: 80vh"}>
                        ...
                        <div class={css_class.profile_header}>
                            ...
                            <div>
                                ...
                                <div class="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class={css_class.profile_info_icon}>
                                    ...
                                    <span>{profile.rating} ({profile.yearsOfExperience} years of experience)</span>
                                </div>
                            </div>
                        </div>
                        <p class={`${css_class.profile_details} ${css_class.text_truncate}`}>{profile.description}</p>
                    </div>
                </div>
            )}</For>
        </div>
