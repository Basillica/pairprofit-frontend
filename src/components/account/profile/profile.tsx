...
export const UserProfile = () => {
  ...
  const posts = [
    {
      ...
      content:
        "This is a sample post content. It can include text, images, and links.",
  ...
  return (
    <div class="flex flex-wrap" style={"width: 96vw"}>
        ...
        <div class={`${css_module.card} mb-4`}>
          ...
          <ul class="list-group list-group-flush">
            <li class={`${css_module.list_group_item}`}>
              ...
              <a href="#">{user.worksAt}</a>
            </li>
            <li class={`${css_module.list_group_item}`}>
              <i class="fas fa-graduation-cap me-2"></i> Studied at{" "}
              <a href="#">{user.studiesAt}</a>
            </li>
            <li class={`${css_module.list_group_item}`}>
              <i class="fas fa-map-marker-alt me-2"></i> Lives in{" "}
              <a href="#">{user.livesIn}</a>
            </li>
            <li class={`${css_module.list_group_item}`}>
              <i class="fas fa-link me-2"></i> <a href="#">{user.website}</a>
            </li>
          </ul>
        </div>
          ...
          <div class={`${css_module.card_body}`}>
            ...
            <ul class="list-unstyled">
              ...
              <li class="text-center mt-3">
                <a href="#" class={`${css_module.text_muted}`}>
                  See All Connections
                </a>
              </li>
            </ul>
      ...
      <div class="md:w-4/12 px-2">
        <div class={`${css_module.card} mb-4`}>
          <div class={`${css_module.card_body}`}>
            ...
            <textarea
              class={`${css_module.list_group_item} mb-2" rows="3"`}
            ...
            <div class={`${css_module.card} mb-4`}>
              <div class={`${css_module.card_body}`}>
                ...
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <a href="#" class={`${css_module.text_muted} me-2`}>
        ...
        <div class="text-center">
          <button class="inline-flex items-center justify-center px-4 py-2 border border-transparent text-base font-medium rounded-md shadow-sm">
            Load More Posts
          </button>
        </div>
      </div>
