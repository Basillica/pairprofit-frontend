...
export const ClientLayout = (props: any) => {
    ...
    const NAV_ITEMS = [
        ...
        { href: '/client/inbox', iconClass: 'fas fa-inbox', text: 'Inbox' },
        {
            href: '/client/notifications',
            iconClass: 'fas fa-bell',
            text: 'Notification',
        },
        { href: '/client/ai', iconClass: 'fas fa-robot', text: 'MrFixit AI' },
        {
            href: '/client/support',
            iconClass: 'fas fa-question-circle',
            text: 'Help & Support',
        },
        { href: '/client/settings', iconClass: 'fas fa-cog', text: 'Settings' },
    ];
    ...
    const NavLink: Component<{
        ...
        const activeClasses =
            'text-primary-blue bg-custom-light-blue font-semibold active-nav-item';
