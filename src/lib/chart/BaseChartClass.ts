...
export const stringToEnumValue = <ET extends Record<string, any>, T>(enumObj: ET, str: string): T => {
    ...
    if (key) {
        ...
        throw new Error(`String "${str}" does not correspond to any value in the provided enum.`);
    }
};
