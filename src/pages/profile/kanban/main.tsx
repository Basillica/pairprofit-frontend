...
export const KanbanBoard = () => {
        ...
        if (task && sourceColumnId && sourceColumnId !== targetColumnId) {
            setColumns((prevColumns) => {
                ...
                if (!updatedSourceColumn || !updatedTargetColumn) {
                    console.error(
                        'Source or target column not found during drop.'
                    );
                    return prevColumns;
                }
    ...
    onMount(() => {
        const handleGlobalClick = (event: MouseEvent) => {
            ...
            dropdowns.forEach((menu) => {
                ...
                if (
                    parentDropdown &&
                    !parentDropdown.contains(event.target as Node)
                ) {
    ...
    const TaskCard = (props: { task: Task; columnId: string }) => {
        ...
        const handleCopyUrl = (e: MouseEvent) => {
            ...
            alert(
                `Copied URL: ${window.location.origin}/tasks/${props.task.id}`
            );
            setIsMenuOpen(false);
        };
        ...
        return (
            <div
                ...
                draggable="true"
                onDragStart={(e) =>
                    handleDragStart(e, props.task, props.columnId)
                }
                onDragEnd={(e) => {
                ...
                <div class="modal" onClick={closeAddTaskModal}>
                    ...
                    >
                        ...
                        <input
                            ...
                            onInput={(e) =>
                                setNewTaskDueDate(e.currentTarget.value)
                            }
                        />
