...
export const LovelyChat = () => {
  ...
  const [showChatView, setShowChatView] = createSignal(
  ...
  createEffect(() => {
    const handleResize = () => {
      setShowChatView(
        window.innerWidth > 768 || (window.innerWidth <= 768 && activeContact())
          ? true
          : false
      );
    };
  ...
  return (
    <div class="container-fluid chat-container">
      <div
        class={`chat-sidebar ${
          showChatView() && window.innerWidth <= 768 ? "hidden" : ""
        }`}
      >
      ...
      <div
        class={`chat-messages-wrapper ${
          showChatView() ? "" : "d-none d-md-block"
        }`}
      >
        ...
        <div class="chat-input-area p-3">
          <div class="chat-input-group">
            <button class="btn btn-light border rounded-pill me-2">
    ...
    <div class={`container-fluid ${css_module.chat_container}`}>
      ...
      >
        ...
        <div
          ...
          style={{
            "padding-top": isMobile() && showChat() ? "3.5rem" : undefined,
          }}
        >
          <For each={messages()}>
            {(message) => (
              ...
              >
                {!message.isUser && (
                  <div
                    class={`${css_module.chat_bubble} bg-light text-dark p-2 rounded-pill`}
                  >
                    {message.text}
                  </div>
                )}
                ...
                {message.isUser && (
                  <div
                    class={`${css_module.chat_bubble} bg-primary text-white p-2 rounded-pill`}
                  >
                    {message.text}
                  </div>
                )}
        ...
        <div class={`${css_module.chat_input_area} p-3 border-top`}>
          <div class={`${css_module.chat_input_group}`}>
            ...
            />
            <button
              class="btn btn-primary rounded-pill ms-2 send-button"
              style={""}
            >
              <i class="fas fa-paper-plane"></i> Send
            </button>
