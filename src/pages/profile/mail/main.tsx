    ...
    <div class="flex flex-col md:flex-row min-h-screen overflow-hidden bg-gray-50 text-gray-800 font-sans">
      ...
      >
        ...
        <div class="mt-auto w-full pt-6 border-t border-gray-200">
          <h3 class="text-md font-semibold text-gray-700 mb-3">Labels</h3>
      ...
      <main class="flex-1 flex flex-col bg-gray-100 rounded-xl shadow-2xl m-4 overflow-hidden">
        <header class="p-5 border-b border-gray-200 flex items-center justify-between bg-white/50 backdrop-blur-sm z-10">
          <div class="flex items-center space-x-4">
            ...
            <h2 class="text-2xl font-bold text-gray-900">
              <Show when={mobileView() === "list"} fallback="Message Detail">
                Inbox
              </Show>
            </h2>
          </div>
        ...
        <div class="flex flex-1 flex-col md:flex-row overflow-hidden">
          ...
          <Show when={mobileView() === "list" || window.innerWidth >= 768}>
              ...
              <div class="space-y-3">
                ...
                >
                  ...
                  <div class="flex-1 min-w-0">
                    ...
                    <p class="font-semibold text-lg text-gray-800 mb-1 truncate">
                      Project Proposal - Exciting Opportunities!
                    </p>
                    <p class="text-gray-600 text-sm truncate">
                      Hello Team, I hope this email finds you well. Attached is
                      the comprehensive project proposal for our new...
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  <div class="flex-1 min-w-0">
                    ...
                    <p class="text-gray-500 text-sm truncate">
                      Hi John, Thank you for reaching out. I've reviewed your
                      request and I'm happy to assist...
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  <div class="flex-1 min-w-0">
                    ...
                    <p class="text-gray-600 text-sm truncate">
                      Hi everyone, Please find attached the latest assets for
                      our upcoming campaign. Your feedback is highly...
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  <div class="flex-1 min-w-0">
                    ...
                    <p class="text-gray-500 text-sm truncate">
                      Your support ticket #12345 has been resolved. Please
                ...
                >
                  ...
                  <div class="flex-1 min-w-0">
                    ...
                    <p class="font-semibold text-lg text-gray-800 mb-1 truncate">
                      Quick Catch-up and Brainstorming Session for Q3
                      Initiatives
                    </p>
                    <p class="text-gray-600 text-sm truncate">
                      Hi, Just wanted to schedule a quick chat to discuss the Q3
                      initiatives and brainstorm some initial ideas. Let me know
                ...
                >
                  ...
                  <div class="flex-1 min-w-0">
                    ...
                    <p class="text-gray-500 text-sm truncate">
                      Check out your progress this week and discover new
                      routines!
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  <div class="flex-1 min-w-0">
                    ...
                    <p class="text-gray-600 text-sm truncate">
                      A groundbreaking study on the impact of artificial
                      intelligence in modern healthcare practices.
                    </p>
                  </div>
                </div>
                <div
                ...
                >
                  ...
                  <div class="flex-1 min-w-0">
                    ...
                    <p class="text-gray-500 text-sm truncate">
                      Don't forget your upcoming HVAC maintenance on June 1st.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <Show when={mobileView() === "detail" || window.innerWidth >= 768}>
              ...
              <div class="bg-white rounded-xl shadow-xl p-8 flex flex-col h-full">
                <div class="flex justify-between items-start mb-6 border-b border-gray-200 pb-4">
                  <div>
                    ...
                    <p class="text-gray-600 text-md flex items-center space-x-2">
                      ...
                      <span class="text-gray-500">to me</span>
                    </p>
                  </div>
                  <div class="flex items-center space-x-3 text-gray-600 text-sm flex-shrink-0">
                    <span class="font-bold">10:30 AM (2 days ago)</span>
                ...
                <div class="flex-1 text-gray-700 leading-relaxed text-md overflow-y-auto custom-scrollbar">
                  ...
                  <p class="mb-4">
                    ...
                    comprehensive project proposal for our new initiative,
                    "Project Aurora." This document outlines the scope,
                    objectives, key deliverables, timeline, and estimated
                    budget.
                  </p>
                  <img
                  ...
                  />
                  <p class="mb-4">
                    We believe this project holds immense potential for
                    expanding our market reach and significantly enhancing our
                    product offerings. We've incorporated feedback from our
                    initial brainstorming sessions and conducted thorough market
                    research to ensure its viability.
                  </p>
                  ...
                  <ul class="list-disc list-inside mb-4 space-y-2 pl-4">
                    ...
                    <li>
                      Detailed financial projections with a clear ROI path.
                    </li>
                  </ul>
                  <p class="mb-4">
                    Please take some time to review the proposal at your
                    earliest convenience. We plan to hold a follow-up meeting on{" "}
                    <span class="font-bold text-blue-500">
                      Friday, June 13th, at 2:00 PM CEST
                    </span>{" "}
                    to discuss any questions, gather feedback, and finalize the
                    next steps.
                  </p>
                  <p class="mb-6">
                    Your insights are invaluable to us as we move forward with
                  ...
                  <div class="mt-8 pt-6 border-t border-gray-200">
                    ...
                    <div class="flex flex-wrap gap-4">
                      ...
                      >
                        ...
                        <span class="text-gray-700">Budget_Breakdown.xlsx</span>
                      </a>
                    </div>
                  </div>
                </div>
