          ...
          datasets: [
            {
              label: "Income (€)",
              data: [
                2500, 3000, 3200, 3800, 4000, 4500, 5000, 4800, 5200, 5500,
                6000, 6500,
              ],
  ...
  return (
    ...
    <div class={css_module.dashboard_container}>
        ...
        <div class="w-full lg:w-6/12 px-2">
          <div class={`${css_module.contact_card}`}>
            ...
            <p class={`${css_module.contact_details}`}>
              ...
              John Smith
              <br />
              <span class={`${css_module.contact_name}`}>Email:</span>{" "}
              john.smith@example.com
              <br />
              <span class={`${css_module.contact_name}`}>Phone:</span> +49 123
              4567890
              <br />
              <span class={`${css_module.contact_name}`}>Address:</span> 123
              Main Street, Erfurt, Germany
            </p>
          </div>
        </div>
        <div class="w-full lg:w-6/12 px-2">
          <div class={`${css_module.contact_card}`}>
            <h2 class={`${css_module.contact_title}`}>Support Contact</h2>
            <p class={`${css_module.contact_details}`}>
              <span class={`${css_module.contact_name}`}>Support Name:</span>{" "}
              Jane Doe
              <br />
              <span class={`${css_module.contact_name}`}>Email:</span>{" "}
              support@example.com
              <br />
              <span class={`${css_module.contact_name}`}>Phone:</span> +49 987
              6543210
              <br />
              <span class={`${css_module.contact_name}`}>Hours:</span> Mon-Fri,
              9 AM - 5 PM (CET)
            </p>
          </div>
        </div>
      ...
      <div class="flex flex-wrap -mx-2">
        ...
        <div class="w-full lg:w-6/12 px-2">
          <div class={`${css_module.chart_card}`}>
            ...
            <div ref={mapDiv} class={`${css_module.map_container}`}></div>
          </div>
        </div>
      </div>
      ...
      <div class="flex flex-wrap -mx-2">
        <div class="w-full lg:w-6/12 px-2">
          <div class={`${css_module.chart_card}`}>
            <h2 class={`${css_module.chart_title}`}>Task Status Overview</h2>
            <canvas
          ...
          <div class={`${css_module.latest_items_wrapper}`}>
            ...
            <div class={`${css_module.latest_items_grid}`}>
              <LatestItemCard
                ...
                details={
                  <>
                    <span class={`${css_module.contact_name}`}>Service:</span>{" "}
                    Plumbing Repair
                    <br />
                    <span class={`${css_module.contact_name}`}>Date:</span> May
                    28, 2025
                  </>
                }
              />
              ...
              <LatestItemCard
                ...
                details={
                  <>
                    ...
                    Carpentry Work
                    <br />
                    <span class={`${css_module.contact_name}`}>Rating:</span> 5
                    Stars
                  </>
                }
              />
              <LatestItemCard
                ...
                details={
                  <>
                    ...
                    HVAC Maintenance
                    <br />
                    <span class={`${css_module.contact_name}`}>Date:</span> June
                    1, 2025
                  </>
                }
              />
