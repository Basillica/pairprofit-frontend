          ...
          <div class="space-y-4">
            <div>
              ...
              <input
                ...
                onInput={(e) =>
                  updateProfileField("fullName", e.currentTarget.value)
                }
            ...
            <div>
              ...
              <p class="mt-1 text-xs text-gray-500">
                Email address cannot be changed directly here for security
                reasons. Please contact support.
              </p>
            </div>
            <div>
              <label
              ...
              <input
                ...
                onInput={(e) =>
                  updateProfileField("phone", e.currentTarget.value)
                }
                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
              />
            </div>
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  onInput={(e) =>
                    updateAddressField("street", e.currentTarget.value)
                  }
                  class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                />
              </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  onInput={(e) =>
                    updateAddressField("postalCode", e.currentTarget.value)
                  }
                  class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                />
              </div>
          ...
          <div class="space-y-4">
            <div>
              <a
                ...
                onClick={(e) => {
                  e.preventDefault();
                  alert("Simulating: Navigate to Change Password page.");
                }}
              >
                Change Password
              </a>
            ...
            <div class="flex items-center justify-between p-3 bg-white border border-gray-200 rounded-md shadow-sm">
              ...
              <label for="2faToggle" class="flex items-center cursor-pointer">
                <div class="relative">
          ...
          <div class="space-y-3">
            <div class="flex items-center">
              <input
                ...
                onChange={(e) =>
                  updateNotificationField("email", e.currentTarget.checked)
                }
            ...
            <div class="flex items-center">
              <input
                ...
                onChange={(e) =>
                  updateNotificationField("inApp", e.currentTarget.checked)
                }
                class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
              />
              <label
            ...
            <div class="flex items-center">
              <input
                ...
                onChange={(e) =>
                  updateNotificationField("sms", e.currentTarget.checked)
                }
                class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
              />
              <label
          ...
          <section class="p-6 bg-purple-50 rounded-lg shadow-inner">
            ...
            <div class="space-y-4">
              <Show when={formData().userType === "customer"}>
                <div>
                  <p class="text-gray-700 mb-2">
                    Manage your saved credit/debit cards or other payment
                    options.
                  </p>
                  <button
                    type="button"
                    onClick={() =>
                      alert("Simulating: Go to Add/Manage Payment Methods")
                    }
              ...
              <Show when={formData().userType === "artisan"}>
                <div>
                  <p class="text-gray-700 mb-2">
                    Manage your bank account details for receiving payouts.
                  </p>
                  <button
                    type="button"
                    onClick={() =>
                      alert("Simulating: Go to Add/Manage Payout Account")
                    }
                    class="px-4 py-2 bg-purple-600 text-white rounded-md hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 text-sm"
                  >
