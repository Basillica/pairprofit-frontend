                ...
                <div class="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg">
                    ...
                    <section class="mb-10 p-6 bg-blue-50 rounded-lg shadow-md">
                        ...
                        <p class="text-gray-700 leading-relaxed mb-4">
                            At **{appName}**, our mission is to seamlessly
                            connect individuals and businesses with skilled
                            local artisans. We believe in empowering local
                            talent and making quality service accessible to
                            everyone. Whether you need a plumber, a carpenter,
                            an electrician, or a painter, we're dedicated to
                            helping you find the right professional for your
                            needs, quickly and reliably.
                        </p>
                        <p class="text-gray-700 leading-relaxed">
                            We strive to build a community founded on trust,
                            transparency, and excellent service. Our platform
                            simplifies the process of hiring and getting hired,
                            ensuring a smooth experience for both customers and
                            artisans.
                        </p>
                    </section>
                    ...
                    <section class="mb-10 p-6 bg-green-50 rounded-lg shadow-md">
                        ...
                        <div class="mb-8">
                            ...
                            <ol class="list-decimal list-inside space-y-3 text-gray-700 ml-4">
                                <li>
                                    <strong>Post a Request:</strong> Describe
                                    the service you need, its location, urgency,
                                    and any specific requirements. It's free and
                                    takes just a few minutes.
                                </li>
                                <li>
                                    <strong>Receive Proposals:</strong>{' '}
                                    Interested artisans will send you proposals
                                    with their offers, estimated costs, and
                                    timelines.
                                </li>
                                <li>
                                    <strong>Compare & Choose:</strong> Review
                                    artisan profiles, ratings, and past reviews.
                                    Chat directly with them to clarify details.
                                </li>
                                <li>
                                    <strong>Hire & Collaborate:</strong> Accept
                                    the best proposal. Track progress and
                                    communicate securely through our platform.
                                </li>
                                <li>
                                    <strong>Review & Rate:</strong> Once the job
                                    is done, leave a review and rating to help
                        ...
                        <div>
                            ...
                            <ol class="list-decimal list-inside space-y-3 text-gray-700 ml-4">
                                <li>
                                    ...
                                    Showcase your skills, experience, portfolio,
                                    and services. Set your pricing and
                                    availability.
                                </li>
                                <li>
                                    <strong>Browse Requests:</strong> Discover
                                    new service requests in your area that match
                                    your expertise.
                                </li>
                                <li>
                                    <strong>Submit Proposals:</strong> Send
                                    tailored proposals to customers, outlining
                                    your approach and cost.
                                </li>
                                <li>
                                    <strong>Get Hired:</strong> Communicate with
                                    potential clients, answer their questions,
                                    and get selected for jobs.
                                </li>
                                <li>
                                    <strong>Manage Your Work:</strong> Use our
                                    tools to communicate, manage milestones, and
                                    receive payments securely.
                                </li>
                                <li>
                                    <strong>Build Your Reputation:</strong>{' '}
                                    Deliver excellent service, earn great
                                    reviews, and grow your clientele.
                                </li>
                            </ol>
                        </div>
                    </section>
                        ...
                        <div class="divide-y divide-gray-200">
                            <details class={about_styles.faqItem}>
                                ...
                                <div class={about_styles.faqContent}>
                                    <p>
                                        Posting a service request as a customer
                                        is completely free. Artisans pay a small
                                        service fee on completed jobs or a
                                        subscription fee for premium features,
                                        which helps us maintain and improve the
                                        platform.
                                    </p>
                                </div>
                            </details>
                            ...
                            <details class={about_styles.faqItem}>
                                ...
                                <div class={about_styles.faqContent}>
                                    <p>
                                        ...
                                        our platform. Customers deposit funds
                                        into an escrow account when they accept
                                        a proposal, and the artisan receives
                                        payment once the job is marked as
                                        complete and the customer is satisfied.
                                    </p>
                                </div>
                            </details>
                            ...
                            <details class={about_styles.faqItem}>
                                ...
                                <div class={about_styles.faqContent}>
                                    <p>
                                        ...
                                        customers and artisans. If issues arise,
                                        try to resolve them directly. If a
                                        resolution isn't found, our dispute
                                        resolution team can mediate. Please
                                        refer to our{' '}
                                        <a
                                            href="#"
                            ...
                            <details class={about_styles.faqItem}>
                                ...
                                <div class={about_styles.faqContent}>
                                    <p>
                                        To increase your chances, ensure your
                                        profile is complete with detailed
                                        services, a strong portfolio, and
                                        competitive pricing. Prompt
                                        communication and excellent reviews for
                                        completed jobs significantly boost your
                            ...
                            <details class={about_styles.faqItem}>
                                ...
                                <div class={about_styles.faqContent}>
                                    <p>
                                        Customers can cancel a request before
                                        accepting a proposal. Once a proposal is
                                        accepted, cancellation terms depend on
                                        the agreement and our{' '}
                                        <a
                                            href="#"
                                            class="text-blue-600 hover:underline"
                                        >
                                        ...
                                        . Artisans can also decline or cancel
                    ...
                    <section class="mb-10 p-6 bg-yellow-50 rounded-lg shadow-md">
                        ...
                        <p class="text-gray-700 leading-relaxed mb-4">
                            ...
                            All artisans on our platform undergo a verification
                            process. We also provide secure messaging,
                            transparent review systems, and a dedicated support
                            team to assist with any issues.
                        </p>
                        <p class="text-700 leading-relaxed">
                            In case of disputes, our team offers mediation
                            services to help reach a fair resolution. We
                            encourage all users to communicate clearly and
                    ...
                    <section class="mb-10 p-6 bg-red-50 rounded-lg shadow-md">
                        ...
                        <p class="text-gray-700 leading-relaxed mb-4">
                            Have more questions or need assistance? Our support
