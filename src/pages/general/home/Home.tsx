...
export const HomePage: Component = () => {
    ...
    const faqs = [
        {
            ...
            answer: 'You can browse our categories or use the search bar on the homepage to find specific services. Filter results by location, ratings, and more.',
        },
        {
            id: 2,
            question: 'Is it free to use PairProfit as a customer?',
            answer: "Yes, it's completely free to browse services, connect with professionals, and receive quotes. We only charge a small service fee on completed transactions.",
        },
        {
            id: 3,
            question: 'How do I become a service provider?',
            answer: "Click on the 'List Your Service Today!' button and follow the simple steps to create your professional profile. We'll guide you through the verification process.",
        },
        {
            id: 4,
            question: "What if I'm not satisfied with a service?",
            answer: 'We have a dispute resolution process in place to ensure fair outcomes. Please contact our support team if you encounter any issues.',
        },
    ];
    ...
    const heroItems: HeroItem[] = [
        ...
        },
        {
            ...
            description:
                'Expert help for parties, corporate events, and gatherings.',
        },
        {
            image: baker,
            title: 'Baking & Confectionery',
            description:
                'Custom cakes, pastries, and baked goods for all occasions.',
        },
        {
            image: bodyguard,
            title: 'Personal Security Services',
            description:
                'Professional bodyguards and close protection specialists.',
        },
        {
            image: chef,
        ...
        },
        {
            ...
            title: 'Explore More',
            description:
                'Discover a wide range of other skilled professionals.',
        },
    ];
        ...
        <main class="flex-grow container-fluid mx-auto">
            <section class="text-center py-16 bg-blue-300 text-white rounded-lg shadow-lg mb-12">
                ...
                <p class="text-xl md:text-2xl mb-8 opacity-90">
                    Connecting you with skilled professionals for every task,
                    big or small.
                </p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center px-4">
                    <div class="p-6">
                        ...
                        <p class="text-gray-600">
                            Browse categories or use our powerful search to find
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600">
                            Chat directly with service providers to discuss
                            project details and get quotes.
                        </p>
                    </div>
                    <div class="p-6">
                        <div class="w-16 h-16 bg-blue-100 text-blue-700 rounded-full flex items-center justify-center mx-auto mb-4 text-3xl font-bold">
                        ...
                        <p class="text-gray-600">
                            Hire with confidence, make secure payments, and
                            leave reviews.
                        </p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 px-4">
                    <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition duration-300">
                        ...
                        <p class="text-gray-600 mb-4">
                            Need help with web design, software, or network
                            issues? Find skilled tech professionals.
                        </p>
                        <a
                            href="/login"
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition duration-300">
                        ...
                        <p class="text-gray-600 mb-4">
                            From emergency plumbing to skilled carpentry, get
                            your home needs sorted efficiently.
                        </p>
                        <a
                            href="/login"
                            class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 transition duration-300 text-sm"
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition duration-300">
                        ...
                        <p class="text-gray-600 mb-4">
                            Elevate your events with gourmet meals and
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-4">
                    <div class="flex items-start p-4 bg-white rounded-lg shadow-sm">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 text-sm">
                                From home services to tech support, find experts
                                for every need.
                            </p>
                        </div>
                    </div>
                    <div class="flex items-start p-4 bg-white rounded-lg shadow-sm">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 text-sm">
                                We ensure all service providers are vetted for
                    ...
                    <div class="flex items-start p-4 bg-white rounded-lg shadow-sm">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 text-sm">
                                Enjoy secure payments and clear communication
                    ...
                    <div class="flex items-start p-4 bg-white rounded-lg shadow-sm">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 text-sm">
                                Find and book services with just a few clicks,
                                hassle-free.
                            </p>
                        </div>
                    </div>
                    <div class="flex items-start p-4 bg-white rounded-lg shadow-sm">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 text-sm">
                                Our team is here to assist you every step of the
                                way.
                            </p>
                        </div>
                    </div>
                    <div class="flex items-start p-4 bg-white rounded-lg shadow-sm">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 text-sm">
                                Get great value for high-quality services from
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 px-4">
                    <div class="bg-white p-6 rounded-lg shadow-md text-gray-800">
                        <p class="italic text-lg mb-4">
                            "PairProfit made it incredibly easy to find a
                            reliable plumber for my emergency. Fast, efficient,
                            and professional!"
                        </p>
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-md text-gray-800">
                        <p class="italic text-lg mb-4">
                            "As a freelance web developer, PairProfit has been a
                            game-changer. I've connected with so many new
            ...
            <section class="text-center py-16 bg-blue-700 text-white rounded-lg shadow-lg mb-12">
                ...
                <p class="text-xl md:text-2xl mb-8 opacity-90 px-4 max-w-3xl mx-auto">
                    Join our growing community and connect with clients looking
                    for your expertise. Take control of your work, set your own
                    rates, and expand your reach.
                </p>
                <a
