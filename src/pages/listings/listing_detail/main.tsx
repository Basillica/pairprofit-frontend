...
export const ListingDetailPage: Component = () => {
    ...
    const submitCallback = () => {
        ...
        if (phone && time) {
            ...
            alert(
                'Please enter your phone number and preferred callback time.'
            );
        }
    };
                ...
                <header class="mb-8 pb-4 border-b border-gray-200 flex flex-col md:flex-row md:items-center md:justify-between">
                    <div>
                        ...
                        <p class="text-lg text-blue-600 font-semibold">
                            Provided by:{' '}
                            <span>{serviceData().providerName || 'N/A'}</span>
                        </p>
                    ...
                    <div class="lg:col-span-2 space-y-8">
                        ...
                        <section>
                            ...
                            <p class="text-gray-700 mb-2">
                                ...
                                {serviceData()
                                    .deliveryMethod.charAt(0)
                                    .toUpperCase() +
                                    serviceData()
                                        .deliveryMethod.slice(1)
                                        .replace('-', ' ')}
                            </p>
                            <Show
                                when={
                                    serviceData().deliveryMethod ===
                                        'on-site' ||
                                    serviceData().deliveryMethod ===
                                        'my-location'
                                }
                        ...
                        <section>
                            ...
                            <div class="mt-4">
                                ...
                                <ul class="list-disc list-inside text-gray-700 space-y-1">
                                    ...
                                    >
                                        <For
                                            each={serviceData().availableTimes}
                                        >
                                            {(slot) => (
                                                <li>
                                                    {slot.from} - {slot.to}
