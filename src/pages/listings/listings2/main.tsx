                    ...
                    <div class="col-12 listing-item" style={'width: 100%'}>
                        <div class={css_class.listing_card}>
                            <div class={css_class.listing_header}>
                                <h3 class={css_class.listing_title}>
                                    {service.title}
                                </h3>
                            ...
                            <div class={css_class.listing_body}>
                                ...
                                <div class={css_class.listing_details}>
                                    ...
                                    <div class={css_class.detail_item}>
                                        <i
                                            class={`fas fa-clock ${css_class.detail_icon}`}
                                        ></i>
                                        <span class={css_class.detail_text}>
                                            {service.description}
                                        </span>
                                    ...
                                    <div class={css_class.detail_item}>
                                        <i
                                            class={`fas fa-tools ${css_class.detail_icon}`}
                                        ></i>
                                        {/* <span class={css_class.detail_text}>
                                            Services:{' '}
                            ...
                            <div class={css_class.listing_footer}>
                                <span class={css_class.listing_price}>
                                    {service.price}
                                </span>
                                {service.is_negotiable && (
                                    <span class={css_class.negotiable}>
                                        Negotiable
                                    </span>
                                )}
                                {service.urgency && (
                                    <span
                                        class={`${css_class.urgency_badge} ${
                                            ...
                                            css_class.urgency_high
                                        } ${
                                            service.urgency === 'medium' &&
                                            css_class.urgency_medium
                                        } ${
                                            service.urgency === 'low' &&
                                            css_class.urgency_low
                                        }`}
                                    >
                                        {service.urgency
                                            .charAt(0)
