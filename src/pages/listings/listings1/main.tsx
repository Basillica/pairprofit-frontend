        ...
        <div class="md:w-6/12 px-2 lg:w-3/12 px-2 mb-2">
          <div class={css_module.listing_card}>
            <div class={css_module.listing_header}>
              ...
              <p class={css_module.listing_provider}>Provided by: {service.provider}</p>
            </div>
            <div class={css_module.listing_body}>
              <p class={css_module.listing_description}>{service.description}</p>
              <div class={css_module.listing_details}>
                <div class={css_module.detail_item}>
                  <i class={`fas fa-map-marker-alt ${css_module.detail_icon}`}></i>
                  <span class={css_module.detail_text}>{service.location}</span>
                </div>
                <div class={css_module.detail_item}>
                  <i class={`fas fa-clock ${css_module.detail_icon}`}></i>
                  <span class={css_module.detail_text}>{service.availability}</span>
                </div>
                <div class={css_module.detail_item}>
                  <i class={`fas fa-tools ${css_module.detail_icon}`}></i>
                  <span class={css_module.detail_text}>Services: {service.servicesOffered.join(', ')}</span>
                </div>
              </div>
            </div>
            <div class={css_module.listing_footer}>
              ...
              <button class={css_module.contact_button}>Contact Provider</button>
            </div>
          </div>
        </div>
      )}</For>
